...
// import { closeModal, removeFromCart } from '@/app/GlobalRedux/store';
...
//             <div onClick={()=>dispatch(closeModal())} className='bg-transparent absolute  inset-0'> </div>
...
//                     <h1>Cart</h1>
//                     <i onClick={()=>dispatch(closeModal())} className="fa-solid cursor-pointer hover:opacity-60 fa-xmark"></i>
